...
public class NotePad {
    ...
    private static final By CloseButton = By.cssSelector("#manageNoteAccessModal > div > div > div.modal-footer > button");
    private static final By noteTitle = By.id("edit_title");
    private static final By saveTitleButton = By.xpath("//*[@id='btnSaveNote']");
    private static final By PrivateButtonIs = By.cssSelector("#noteAccessLabel");
